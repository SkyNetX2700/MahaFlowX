...
import { ArrowRight, Building2, Check, KeyRound, LogOut, MapPin } from "lucide-react";
...
export const AuthorityOnboarding = ({ session, onComplete, onCancel }) => {
  ...
  return <main className="onboarding-shell" data-testid="authority-onboarding-page"><header><BrandLogo testId="authority-onboarding-logo"/><button className="outline-button" data-testid="authority-onboarding-cancel-button" onClick={onCancel}><LogOut size={16}/> Sign out</button></header><section className="onboarding-panel">
