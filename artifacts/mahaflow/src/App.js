...
export default function App() {
  ...
  if (process.env.NODE_ENV === "development" && window.location.pathname === "/map-health") return <main className="map-health" data-testid="map-health-page"><h1>Google Maps diagnostic</h1><MapView/><p data-testid="map-health-help">This preview-only route uses the same key and component as MahaFlow workspaces.</p></main>;
