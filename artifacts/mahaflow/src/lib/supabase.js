...
export const supabaseConfig = {
  ...
  anonKey: import.meta.env.VITE_SUPABASE_ANON_KEY || import.meta.env.REACT_APP_SUPABASE_ANON_KEY,
  configured: Boolean(
...
export const supabaseSetupMessage = "Add VITE_SUPABASE_URL and VITE_SUPABASE_ANON_KEY to activate Supabase Auth, RLS, Storage and Realtime.";